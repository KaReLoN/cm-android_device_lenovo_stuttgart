...
#// Commented out until Lenovo drops kernel source - build using blobs/prebuilt kernel only
...
TARGET_IGNORE_HARDWARE_SAMSUNG := true
...
TARGET_CUSTOM_RELEASETOOL := device/lenovo/stuttgart/squisher
