...
struct yamaha_mc1n2_audio_params_init stuttgart_params_init = {
    .ae_info = {
        .bOnOff = 0x00,
        .abBex = { 0x00 },
        .abWide = { 0x00 },
...
struct yamaha_mc1n2_audio_params_route stuttgart_params_routes[] = {
    {
...
struct yamaha_mc1n2_audio_device_ops stuttgart_ops = {
    .hw_node = "/dev/snd/hwC0D0",
    .hw_fd = -1,
    .params = {
        .init = &stuttgart_params_init,
        .routes = &stuttgart_params_routes,
        .routes_count = sizeof(stuttgart_params_routes) /
            sizeof(struct yamaha_mc1n2_audio_params_route),
    },
};

struct yamaha_mc1n2_audio_pdata stuttgart_pdata = {
    .name = "stuttgart",
    .ops = &stuttgart_ops,
};
